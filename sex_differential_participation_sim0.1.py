...
out_bucket = 'gs://mattia-simulations/simulations_0.1/'

# Select phenotype columns and convert to pandas dataframe for sampling
# mt.y:
# y0:y3    h2 = 0.1
# y4:y7    h2 = 0.3
...
for k in K:
    for o in OR:
        ...
        df.loc[(df['sex'] == 0), 'z'] = df.loc[(df['sex'] == 0), 'z'] * k  # Zm = Z*K
