wilson2ldhub=function(file="simul/gwas/edu_sex.tsv.gz",out="simul/ldhub/edu_sex.sumstat"){
  ...
  system(paste0("munge_sumstats.py --sumstats ",file," --a1 a1 --a2 a0 --p p --signed-sumstats beta1,0  --merge-alleles /exports/igmm/eddie/wilson-lab/apps_by_us_full_stuff/ldsc/data/w_hm3.snplist --out ",out,"_mung"))
