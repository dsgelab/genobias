...
phenos=fread("../GWAS/phenotype_simul.txt")

### Create outcome object from UKB
## T2D no sex
t2d.all=fread("../GWAS/p05_comb_chr/t2d_or.tsv.gz")
...
t2d.all=fread("../GWAS/p05_comb_chr/t2d_sex.tsv.gz")
...
## T2D original Male
t2d.all=fread("../GWAS/p05_comb_chr/t2d_m.tsv.gz")
...
## T2D original Female
t2d.all=fread("../GWAS/p05_comb_chr/t2d_f.tsv.gz")
...
### T2D bias no sex
t2d.all=fread("../GWAS/p05_comb_chr/t2d_new.tsv.gz")
...
### T2D bias sex
t2d.all=fread("../GWAS/p05_comb_chr/t2d_new_sex.tsv.gz")
...
### T2D bias Male
t2d.all=fread("../GWAS/p05_comb_chr/t2d_m_new.tsv.gz")
...
### T2D bias Male
t2d.all=fread("../GWAS/p05_comb_chr/t2d_f_new.tsv.gz")
...
library(ggplot2)
pdf("MR_results_BMI_bias_2_traits.pdf",height=7)
