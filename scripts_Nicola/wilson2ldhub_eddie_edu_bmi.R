...
done.files=system("ls sumstats/*.gz",intern=T)
a=gsub("../GWAS/p05_comb_chr/","",gsub(".tsv.gz","",file.list))
b=gsub("sumstats/","",gsub(".tsv_mung.sumstats.gz","",done.files))

file.list=file.list[which(!(a%in%b))]
