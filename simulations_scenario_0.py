...
output_bucket = 'gs://mattia-simulations/EUR350_scenario_0/'
...
OR_y0 = [1.2, 1.5, 1.8, 2, 4, 6, 8, 10]

OR_y1 = [1.2, 1.5, 1.8, 2, 4]


output_bucket = 'gs://mattia-simulations/EUR350_scenario_0/10/'
# Sampling on y0, h2(y0) = 0.1
i = 0
for ory0 in OR_y0:
    i += 1
...
output_bucket = 'gs://mattia-simulations/EUR350_scenario_0/30/'
# Sampling on y2, h2(y2) = 0.3
i = 0
for ory0 in OR_y0:
    i += 1
